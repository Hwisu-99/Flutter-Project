...
class GraphChartYear extends StatefulWidget {
  const GraphChartYear({Key? key}) : super(key: key);

  @override
  State<GraphChartYear> createState() => _GraphChartYearState();
}

class _GraphChartYearState extends State<GraphChartYear> {
        ...
        child: SfCartesianChart(
          ...
          primaryXAxis: DateTimeAxis(
            // x축에 표시되는 날짜들의 범위 : 오늘 날짜로부터 +-4일
              minimum: DateTime(today.year,today.month-5,1),
              maximum: DateTime(today.year,today.month+6,1),
